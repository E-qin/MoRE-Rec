...
class PPO_Selector:
    def __init__(self, args):
        # batch size and mini batch size setup
        ...
        # epsilon-greedy's random threshold, epsilon = 1 - random_thresh
        self.random_thresh = args.random_thresh
    ...
    def save(self, total):
        torch.save(self.actor.state_dict(), './rl_select/Meta-Reflect/'+ self.savedir +'_epoch_'+ str(total) + '.pth')
